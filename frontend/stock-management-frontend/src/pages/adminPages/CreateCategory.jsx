      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-gray-600">Add a new category to organize your items</p>
            </div>
            <div className="hidden sm:block">
              <div className="flex items-center gap-2 px-4 py-2 bg-blue-50 rounded-lg">
                <FaTags className="text-blue-600" />
                <span className="text-sm font-medium text-blue-700">New Category</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700">
            ...
            <p className="text-sm text-blue-100 mt-1">Fill in the details below to create a new category</p>
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <h4 className="text-sm font-medium text-blue-800">Tips for Good Category Names</h4>
                <ul className="mt-1 text-sm text-blue-700 space-y-1">
                  <li>• Use clear and descriptive names</li>
                  <li>• Keep names short (2-3 words max)</li>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <ul className="mt-1 text-sm text-green-700 space-y-1">
                  <li>• Category will be available for items</li>
                  <li>• Can be managed from category list</li>
                  <li>• Can be deactivated if needed</li>
                </ul>
              </div>
            </div>
          </div>
